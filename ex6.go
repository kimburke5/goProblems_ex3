...
func Reflect(input string) string {
 ...
 func ElizaResponse(input string) string {
	 ...
	 if matched,_ := regexp.MatchString(`(?i).*\bcomputers\b.*`,input);matched{
		 
		 return "Do you feel threatened by computers?"
	 }

	 if matched,_ := regexp.MatchString(`(?i).*\bdreams\b.*`,input);matched{
		 
		 return "Perhaps the answer lies within yourself?"
	 }

	if matched,_ := regexp.MatchString(`(?i).*\breal\b.*`,input);matched{
		 
		 return "Please consider whether you can answer your own question?"
	 }
 ...
 func main() {
	...
	fmt.Println("I really do not understand computers!")
	fmt.Println(ElizaResponse("I really do not understand computers!"))
	fmt.Println();
	
	fmt.Println("Sometimes my dreams seem unreachable!")
	fmt.Println(ElizaResponse("Sometimes my dreams seem unreachable!"))
	fmt.Println();

	fmt.Println("How am I supposed to know if you are real?")
	fmt.Println(ElizaResponse("How am I supposed to know if you are real?"))
	fmt.Println();	
